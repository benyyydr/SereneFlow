Shader "UI/Glassmorphism"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Distância a um rectângulo arredondado, centrado em (0,0)
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                // SDF para cantos arredondados
                float dist = roundedBoxSDF(centered, float2(0.5, 0.5), _CornerRadius);

                // Máscara global (descarta fora dos cantos arredondados)
                ...
                // Aplica máscara dos cantos
                corFinal.a *= mask;

                // Multiplica pela cor do vertex/Image
                corFinal *= IN.color;
